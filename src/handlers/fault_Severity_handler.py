...
class FaultSeverityHandler(Handler):
    ...
    def __init__(
        ...
        image_model_path: str = "dashboard/models/hotspot_yolo.pt",
    ) -> None:
        ...
        self.__electrical_strategy = SeverityStrategy(
            electrical_model_path, electrical_scaler_path, electrical_encoder_path
        )
    ...
    def pre_process_data(self, image_data: Any = None, string_data: Any = None) -> None:
        ...
        try:
            ...
            if string_data is not None and len(string_data) > 0:
                ...
                self.__logger.info(
                    f"Electrical features prepared: {self.__processed_electrical_data.shape}"
                )
    ...
    def apply_model(self) -> None:
        ...
        if self.__processed_electrical_data is not None:
            ...
            el_result = self.__detection_context.perform_detection(
                self.__processed_electrical_data
            )
        ...
        if self.__processed_image_path is not None:
            ...
            img_result = self.__detection_context.perform_detection(
    ...
    def present_results(self) -> None:
        ...
        self.result = AnalysisResult(
            ...
            image_confidence=(
                float(self.__last_run_details.get("confidence", 0.0))
                if is_image
                else 0.0
            ),
            reading_confidence=(
